...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const apiKey = 'IsDssiTLL9hE7ofCV1Ot' // apikey you can get it at https://mhankbarbar.herokuapp.com/api
        ...
        const ownerNumber = ["6285812052529@c.us","6281946983575"] // replace with your whatsapp number
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/binangnurpradana', donate)
            break
        case '!tts':
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '6285812052529@c.us')
            break
        case '!ig':
        ...
        case '!bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ C3P3K312S BOT Broadcast ]\n\n${msg}`)
            }
        ...
        case '!join':
            ...
            if (tGr.length > 1000) return client.reply(from, 'Maaf jumlah group sudah maksimal!', id)
        ...
        case '!readme':
            ...
            break
        case '!info':
            client.sendLinkWithAutoPreview(from, 'https://github.com/Bintang73/botst4rz', info)
            break
        case '!snk':
